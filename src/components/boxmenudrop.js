...
import logo from "../images/javazol logo.png"
    ...
    <div className="dropdown" onClick={handleToggle} ref={wrapperRef}>
      ...
      >
        <div className="drop-item">
          ...
          <a className="drop-link" href="mailto:faizollama11@gmail.com">
            <img
              src={email}
              alt=""
            />
          ...
          <a className="drop-link" href="https://github.com/izolama">
            <img
              src={gh}
              alt=""
            />
          ...
          <a className="drop-link" href="https://www.linkedin.com/in/faizol-ama-955a13195/">
            <img
              src={li}
              alt=""
            />
